...
(custom-set-variables
 ...
 '(package-selected-packages
   '(add-node-modules-path amx apheleia archive-rpm atomic-chrome browse-kill-ring cider color-theme-sanityinc-tomorrow company company-statistics counsel diminish dockerfile-mode dotenv-mode dumb-jump editorconfig el-mock erlang fish-mode flx gptel hydra ivy js-comint ligature lua-mode magit markdown-mode maxframe minions modus-themes nix-ts-mode package-utils polymode reformatter rg rust-mode slime swift-mode swiper terraform-mode transient web-mode wgrep yaml-mode))
