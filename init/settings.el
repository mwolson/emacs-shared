...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (js-comint flymake-eslint add-node-modules-path erlang editorconfig docker-tramp el-mock dumb-jump company-statistics company spaceline package-utils wgrep swiper diminish counsel ivy color-theme-sanityinc-tomorrow maxframe markdown-mode lua-mode smex dockerfile-mode browse-kill-ring ripgrep flx projectile yaml-mode slime cider magit hydra web-mode)))
